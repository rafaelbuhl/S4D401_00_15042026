...
CLASS lcl_flight DEFINITION ABSTRACT.
  ...
  PUBLIC SECTION.
    ...
    "! Demo einer <strong>Dokumentation</strong>
    "! @parameter i_connection_id |
    "! @parameter i_flight_date |
...
CLASS lcl_carrier DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    "! @raising zcx_00_failed | Ausnahmetext bei fehlgeschlagener Instanziierung
...
"! Beispiel für einen Link:<br>
"! {@link .lcl_flight.data:carrier_id}<br>
"! {@link .lcl_flight.data:connection_id}<br>
"! {@link .lcl_flight.data:flight_date}<br>
